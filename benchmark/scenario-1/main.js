...
function scenario_1() {
    ...
    let subscription_1 = create_subscription(h, s, application_id, [event_type_1, event_type_2], config.targetUrl, "all", "yes");
    ...
    let subscription_2 = create_subscription(h, s, application_id, [event_type_1], config.targetUrl, "all", "yes");
