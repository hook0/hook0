...
module.exports = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Hook0 est-il hébergé en UE, contrairement à Hookdeck ?', a: 'Hook0 Cloud est opéré par une société française (FGRibreau SARL) sur infrastructure française (Clever Cloud), donc hors juridiction du CLOUD Act américain, et tes payloads webhook restent en UE. Hookdeck est une société américaine. Tu peux aussi auto-héberger Hook0 pour qu\'aucune donnée webhook ne quitte ton réseau.' },
