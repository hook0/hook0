...
module.exports = {
  ...
  hero: {
    ...
    titleAccent: 'Alternative open source',
    subtitle: 'Tu cherches une alternative à Hookdeck ? Hook0 est une plateforme webhook open source (SSPL-1.0), hébergée en UE, sans verrouillage fournisseur. Hookdeck répartit le travail entre son Event Gateway et Outpost, son produit de livraison. Voilà ce que chacun couvre vraiment.',
  ...
  platformVsGateway: {
    ...
    hook0: {
      ...
      bullets: [
        ...
        'Open source (SSPL-1.0), auto-hébergeable',
      ],
    },
    hookdeck: {
