...
module.exports = {
  ...
  faq: {
    ...
    items: [
      { q: 'Hookdeck est-il en open source ?', a: 'Non. Hookdeck est en code fermé et cloud uniquement. Tu ne peux pas inspecter le code, l\'auditer ni l\'auto-héberger. Si l\'open source compte pour toi, les alternatives comme Hook0 (SSPL-1.0) ou Convoy (MPL-2.0) sont entièrement ouvertes.' },
