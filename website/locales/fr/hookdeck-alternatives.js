...
module.exports = {
  ...
  faq: {
    ...
    items: [
      { q: 'Hookdeck est-il en open source ?', a: 'En partie. Outpost, le composant de livraison de Hookdeck, est sous Apache-2.0 et auto-hébergeable, et le dépôt est actif. L\'Event Gateway qui ingère les webhooks reste en code fermé et cloud uniquement. Hook0 est à code source ouvert sous SSPL-1.0, avec toute la plateforme auto-hébergeable. Convoy est sous Elastic License 2.0, une licence à source disponible non approuvée OSI, qui interdit de proposer Convoy en service managé.' },
