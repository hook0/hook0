...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      { criteria: 'Licence', svixHtml: 'MIT (open core, entreprise fermé)', hook0Html: 'SSPL-1.0 (source intégrale disponible)', hookdeckHtml: 'Partiel (Outpost en Apache-2.0 ; Event Gateway fermé)', convoyHtml: 'Source ouverte (Elastic License 2.0, non approuvée OSI)', hostedhooksHtml: 'Code fermé' },
      ...
      { criteria: 'Niveau open source', svixHtml: 'Partiel (open core)', hook0Html: 'Total (SSPL, sans add-ons fermés)', hookdeckHtml: 'Partiel (Outpost seulement)', convoyHtml: 'Source ouverte (Elastic License 2.0, non approuvée OSI)', hostedhooksHtml: 'Aucun' },
    ],
  },
  faq: {
    eyebrow: 'FAQ',
