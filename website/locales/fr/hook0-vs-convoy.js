...
module.exports = {
  ...
  differentiators: {
    ...
    cards: [
      ...
      { title: 'Hébergement européen vs infra DIY', body: 'Le cloud Hook0 tourne en Europe, conçu pour le RGPD dès le départ. Avec Convoy, tu choisis ta localisation d\'hébergement, mais tu prends aussi tout le stack ops, monitoring, backups, scaling, uptime. Pas d\'option managée, tout est sur ton dos.' },
    ],
  },
  comparison: {
    ...
    rows: [
      ...
      { feature: 'Cloud managé', hook0Html: 'Oui (hébergé UE)', convoyHtml: 'Non' },
