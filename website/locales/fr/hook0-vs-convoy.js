...
module.exports = {
  ...
  differentiators: {
    ...
    cards: [
      ...
      { title: 'Hébergement européen vs infra DIY', body: 'Le cloud Hook0 fait tourner son plan de données en France chez Clever Cloud (CDN Cloudflare US divulgué dans le <a href="/fr/accord-traitement-donnees">DPA</a>), conçu pour le RGPD dès le départ. Avec Convoy, tu choisis ta localisation d\'hébergement, mais tu prends aussi tout le stack ops, monitoring, backups, scaling, uptime. Pas d\'option managée, tout est sur ton dos.' },
    ],
  },
  comparison: {
