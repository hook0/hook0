...
// Hook0 = « code source ouvert (SSPL-1.0) ». Convoy = Elastic License 2.0, non approuvée OSI, donc « source ouverte » sans « open source ».
// Hookdeck : Outpost (envoi) est en Apache-2.0 et auto-hébergeable ; seul l'Event Gateway (ingestion) reste fermé. Société canadienne.
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      { criteria: 'Code source', hook0Html: 'Oui (SSPL-1.0, source intégrale)', svixHtml: 'Partiel (open core, entreprise fermé)', hookdeckHtml: 'Partiel (Outpost en Apache-2.0 ; Event Gateway fermé)', convoyHtml: 'Source ouverte (Elastic License 2.0, non approuvée OSI)' },
  ...
  difference: {
    ...
    cards: [
      { title: 'Une plateforme, pas deux produits', body: 'Hookdeck coupe le sujet en deux : l\'Event Gateway d\'ingestion reste fermé et cloud uniquement, tandis qu\'Outpost gère l\'envoi sortant en Apache-2.0. Hook0 livre l\'envoi, les relances, les signatures et le portail abonnés dans une seule plateforme, et le code que tu auto-héberges est celui qu\'on fait tourner.' },
