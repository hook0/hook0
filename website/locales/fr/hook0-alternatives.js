...
module.exports = {
  ...
  pageDescription: 'Tu cherches des alternatives à Hook0 ? Compare Hook0, Svix, Hookdeck et Convoy côte à côte sur les licences, l\'auto-hébergement, le pricing et les fonctionnalités.',
  ...
  whatTheyLeftOut: {
    ...
    cards: [
      ...
      { title: '« Le pricing est flou »', body: 'Notre pricing est public et à l\'event. Pas d\'appel commercial requis. Pas de mur « contactez-nous ». Cloud démarre à 59 €/mois, 8x moins cher que Svix pour des features comparables. Bonne chance pour obtenir cette transparence d\'un concurrent VC-funded et fermé.', color: 'green' },
      { title: 'Ce qu\'ils ne diront pas, le financement', body: 'Hookdeck a levé 3,5 M$ en VC. Svix, 17 M$. Convoy est aussi VC-funded. Hook0 est 100% bootstrappé. Quand ton fournisseur webhook doit faire x10 de revenus pour satisfaire ses investisseurs, devine à qui les prix vont monter ? Pas chez nous.', color: 'indigo' },
    ],
  },
  difference: {
    ...
    cards: [
      ...
      { title: 'Européen et RGPD', body: 'Cloud hébergé en UE. Souveraineté des données intégrée. Bootstrappé, pas de board de VC américains qui décident de ta politique de données.' },
    ],
  },
  faq: {
    eyebrow: 'FAQ',
