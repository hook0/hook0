...
module.exports = {
  ...
  differentiators: {
    ...
    cards: [
      ...
      { title: 'Hébergement UE, juridiction française', body: 'Hook0 Cloud est opéré par une société française avec le plan de données applicatif hébergé en France chez Clever Cloud. Le CDN Cloudflare (USA) reste exposé au CLOUD Act et est divulgué dans notre <a href="/fr/accord-traitement-donnees">DPA</a>. Svix est basé aux États-Unis. Tu peux aussi auto-héberger pour qu\'aucune donnée webhook ne quitte ton réseau.' },
    ],
  },
  comparison: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Puis-je utiliser Hook0 pour des charges réglementées ou sensibles à la conformité ?', a: 'Oui. Le plan de données applicatif de Hook0 Cloud reste en France chez Clever Cloud, opéré par une société française hors juridiction du CLOUD Act américain. Le CDN Cloudflare (USA) reste exposé au CLOUD Act et est divulgué dans nos <a href="/fr/sous-traitants-rgpd">sous-traitants RGPD</a> et notre <a href="/fr/accord-traitement-donnees">DPA</a> (transfert encadré par SCC 2021 + TIA, EU-US DPF quand applicable). Comme le code source intégral du serveur est ouvert (SSPL-1.0), tu peux auditer précisément la façon dont les données sont gérées et tu n\'es jamais verrouillé. Les attestations tierces formelles comme SOC 2, HIPAA et PCI-DSS sont prévues.' },
      { q: 'Hook0 est-il hébergé en UE et hors du CLOUD Act américain ?', a: 'Hook0 Cloud est opéré par une société française (FGRibreau SARL), avec le plan de données applicatif hébergé en France chez Clever Cloud. Le CDN Cloudflare (USA) reste exposé au CLOUD Act et est divulgué dans nos <a href="/fr/sous-traitants-rgpd">sous-traitants RGPD</a> et notre <a href="/fr/accord-traitement-donnees">DPA</a> (transfert encadré par SCC 2021 + TIA, EU-US DPF quand applicable). Svix et Hookdeck sont des sociétés américaines. Tu peux aussi auto-héberger Hook0 pour qu\'aucune donnée webhook ne quitte ton réseau.' },
