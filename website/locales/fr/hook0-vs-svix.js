...
module.exports = {
  ...
  hero: {
    ...
    subtitle: 'Tu cherches une alternative à Svix ? Tous deux sont des plateformes webhook, mais ils divergent sur la licence, le modèle de financement, l\'hébergement et ce que veut vraiment dire « open source » en pratique. Hook0 est open source (SSPL-1.0), bootstrappé, hébergé en UE, sans verrouillage fournisseur.',
