...
module.exports = {
  ...
  pageDescription: 'Beide quelloffen, beide auf PostgreSQL. Vergleich Hook0 (Rust, SSPL-1.0, Managed Cloud) und Convoy (Go, MPL-2.0, nur Selbst-Hosting). Features und Kompromisse Seite an Seite.',
