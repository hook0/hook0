...
module.exports = {
  ...
  about: {
    ...
    overviewP: 'Hook0 ist eine quelloffene Webhooks-as-a-Service-Plattform (SSPL-1.0), die Entwicklern hilft, Webhooks im großen Maßstab zu senden, zu empfangen und zu verwalten. Gegründet in Nantes, Frankreich, ist Hook0 zu 100% bootstrapped, ohne Wagniskapital-Finanzierung.',
    keyFactsH3: 'Eckdaten',
    facts: [
      { labelHtml: 'Gegründet:', valueHtml: 'Nantes, Frankreich' },
      { labelHtml: 'Finanzierung:', valueHtml: '100% bootstrapped, ohne VC' },
    ...
    boilerplateQuote: '« Hook0 ist eine quelloffene Webhook-Plattform (SSPL-1.0), die Entwicklern ermöglicht, zuverlässige, skalierbare event-getriebene Integrationen zu bauen. Mit Sitz in Frankreich und zu 100% bootstrapped, engagiert sich Hook0 dafür, Software zu bauen, die der Zeit standhält. »',
  },
  usage: {
    eyebrow: 'Guidelines',
    h2: 'Markennutzung',
