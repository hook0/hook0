...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { criteria: 'Open Source', hookdeckHtml: 'Nein (Closed Source)', hook0Html: 'Ja (SSPL-1.0, gesamter Quellcode)', svixHtml: 'Teilweise (Open Core, Enterprise geschlossen)', convoyHtml: 'Ja (MPL-2.0)', awsEventbridgeHtml: 'Nein (AWS-proprietär)' },
      ...
      { criteria: 'Datenhosting', hookdeckHtml: 'In den USA', hook0Html: 'Europa (DSGVO) oder Selbst-Hosting', svixHtml: 'In den USA', convoyHtml: 'Nur Selbst-Hosting', awsEventbridgeHtml: 'Multi-Region (AWS)' },
