...
module.exports = {
  ...
  whyLookBeyond: {
    ...
    cards: [
      ...
      { title: 'Du willst den Quellcode auditieren', body: 'Outpost steht unter Apache-2.0, Hookdecks Zustellungscode ist also lesbar. Das Event Gateway, das deine Webhooks entgegennimmt, bleibt aber geschlossen. Hook0\'s gesamter Codebase ist Open Source unter SSPL-1.0 und die Managed Cloud läuft auf genau diesem Code, du kannst jede Zeile lesen und auditieren.', color: 'indigo' },
    ],
  },
  faq: {
    eyebrow: 'FAQ',
    h2: 'Häufige Fragen',
    items: [
      { q: 'Ist Hookdeck Open Source?', a: 'Teilweise. Outpost, Hookdecks Zustellungskomponente, steht unter Apache-2.0, ist selbst-hostbar und das Repository ist aktiv. Das Event Gateway, das Webhooks entgegennimmt, bleibt Closed Source und nur Cloud. Hook0 ist unter SSPL-1.0 vollständig Open Source, die gesamte Plattform ist selbst-hostbar. Convoy steht unter der Elastic License 2.0, source-available wie Hook0s SSPL-1.0, und diese Lizenz verbietet es, Convoy als Managed Service anzubieten.' },
