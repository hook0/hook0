...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { criteria: 'Finanzierung', svixHtml: '17 Mio. $ VC-finanziert', hook0Html: '100% bootstrapped', hookdeckHtml: '3,5 Mio. $ VC-finanziert', convoyHtml: 'VC-finanziert', hostedhooksHtml: 'Bootstrapped' },
      ...
      { criteria: 'Datenhosting', svixHtml: 'In den USA', hook0Html: 'Europa (DSGVO) oder Selbst-Hosting', hookdeckHtml: 'In den USA', convoyHtml: 'Nur Selbst-Hosting', hostedhooksHtml: 'In den USA' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Was ist die beste Svix-Alternative für Startups?', a: 'Hook0 funktioniert gut für Startups. Kostenloser Tarif, ohne Kreditkarte, Event-basierter Preis ab 59 €/Monat und kostenloses Selbst-Hosting via Docker oder Kubernetes. Das Unternehmen ist zu 100% bootstrapped, also kein VC, der nächstes Quartal auf höhere Preise drängt. Convoy ist auch einen Blick wert, falls dir die MPL-2.0-Lizenz wichtig ist.' },
