...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      { criteria: 'Lizenz', svixHtml: 'MIT (Open Core, Enterprise geschlossen)', hook0Html: 'SSPL-1.0 (gesamter Quellcode verfügbar)', hookdeckHtml: 'Teilweise (Outpost Apache-2.0; Event Gateway geschlossen)', convoyHtml: 'Quelloffen verfügbar (Elastic License 2.0, nicht OSI-anerkannt)', hostedhooksHtml: 'Closed Source' },
      ...
      { criteria: 'Open-Source-Level', svixHtml: 'Teilweise (Open Core)', hook0Html: 'Vollständig (SSPL, keine geschlossenen Add-ons)', hookdeckHtml: 'Teilweise (nur Outpost)', convoyHtml: 'Quelloffen verfügbar (Elastic License 2.0, nicht OSI-anerkannt)', hostedhooksHtml: 'Keiner' },
    ],
  },
  faq: {
    eyebrow: 'FAQ',
