...
// Hook0 = « quelloffen (SSPL-1.0) ». Convoy = Elastic License 2.0, nicht OSI-anerkannt, also « quelloffen verfügbar » statt « Open Source ».
...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      { criteria: 'Quellcode', hook0Html: 'Ja (SSPL-1.0, gesamter Quellcode)', svixHtml: 'Teilweise (Open Core, Enterprise geschlossen)', hookdeckHtml: 'Teilweise (Outpost Apache-2.0; Event Gateway geschlossen)', convoyHtml: 'Quelloffen verfügbar (Elastic License 2.0, nicht OSI-anerkannt)' },
  ...
  faq: {
    ...
    h2: 'Häufige Fragen',
    items: [
      { q: 'Was sind die besten Hook0-Alternativen?', a: 'Die Haupt-Alternativen zu Hook0 sind Svix (Open Core, MIT-Kern mit geschlossenen Enterprise-Funktionen, VC-finanziert), Hookdeck (kanadisches Unternehmen: das Event Gateway für die Ingestion bleibt geschlossen und nur in der Cloud, während Outpost, seine Zustell-Engine, Apache-2.0 und selbst hostbar ist) und Convoy (quelloffen verfügbar unter der Elastic License 2.0, nicht OSI-anerkannt, aktiv gepflegt vom Unternehmen frain-dev, VC-finanziert). Jede löst einen anderen Teil des Webhook-Problems. Hook0 ist die einzige, die vollständig quelloffen (SSPL-1.0), bootstrappt und kostenlos selbst-hostbar ist.' },
      ...
      { q: 'Soll ich Svix oder Hook0 nutzen?', a: 'Beide sind Webhook-Plattformen, aber sie unterscheiden sich in Lizenzierung und Finanzierung. Svix ist Open Core (Enterprise-Features sind geschlossen) und hat 17 Mio. $ VC eingesammelt. Hook0 ist vollständig quelloffen unter SSPL, bootstrappt, und bietet kostenloses Selbst-Hosting. Wenn dir Anbieter-Unabhängigkeit und langfristige Preisstabilität wichtig sind, ist Hook0 die sicherere Wahl.' },
      { q: 'Was kostet Hook0?', a: 'Hook0 hat einen kostenlosen Tarif ohne Kreditkarte. Hook0 ist auch quelloffen und selbst-hostbar für Compliance-Anforderungen. Hook0 Cloud ergänzt um verwaltete Infrastruktur, EU-Hosting, automatische Updates und Priority-Support. Bezahlte Tarife starten bei 59 €/Monat mit Event-basierter Abrechnung.' },
