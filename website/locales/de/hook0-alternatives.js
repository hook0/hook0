...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { criteria: 'Datenhosting', hook0Html: 'Europa (Clever Cloud FR, CDN Cloudflare USA) oder Selbst-Hosting', svixHtml: 'In den USA', hookdeckHtml: 'In den USA', convoyHtml: 'Nur Selbst-Hosting' },
