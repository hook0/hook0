...
module.exports = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { feature: 'Datenhosting', hook0Html: 'Europa (auf DSGVO-Konformität ausgelegt) oder Selbst-Hosting', hookdeckHtml: 'Sitz in den USA' },
    ],
  },
  faq: {
    eyebrow: 'FAQ',
    ...
    items: [
      ...
      { q: 'Ist Hook0 quelloffen?', a: 'Der Hook0-Server wird unter SSPL-1.0 veröffentlicht und die SDKs unter MIT. SSPL ist eine Copyleft-Lizenz mit verfügbarem Quellcode, du darfst die gesamte Plattform frei prüfen, ändern und selbst hosten. Hookdeck ist geschlossen und nur als Managed-SaaS verfügbar.' },
      ...
      { q: 'Ist Hook0 in der EU gehostet, anders als Hookdeck?', a: 'Hook0 Cloud wird von einem französischen Unternehmen (FGRibreau SARL) auf französischer Infrastruktur (Clever Cloud) betrieben und fällt damit nicht unter die Zuständigkeit des US CLOUD Act, deine Webhook-Payloads bleiben in der EU. Hookdeck ist ein US-Unternehmen. Du kannst Hook0 auch selbst hosten, damit keine Webhook-Daten dein Netzwerk verlassen.' },
