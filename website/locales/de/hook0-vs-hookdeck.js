...
module.exports = {
  ...
  hero: {
    ...
    titleAccent: 'Open-Source-Webhook-Alternative',
    subtitle: 'Suchst du eine Alternative zu Hookdeck? Hook0 ist eine Webhook-Plattform, Open Source (SSPL-1.0), in der EU gehostet, ohne Anbieter-Lock-in. Hookdeck teilt die Arbeit zwischen seinem Event Gateway und Outpost auf, seinem Zustellprodukt. Hier siehst du, was jede Lösung wirklich abdeckt.',
  ...
  platformVsGateway: {
    ...
    hook0: {
      ...
      bullets: [
        ...
        'Open Source (SSPL-1.0), selbst-hostbar',
      ],
    },
    hookdeck: {
