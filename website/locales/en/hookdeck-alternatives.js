...
module.exports = {
  ...
  hero: {
    ...
    subtitleHtml: 'Hookdeck\'s Event Gateway receives and routes incoming webhooks, and sending runs through a second product, Outpost. If you want a single platform to <strong class="text-white">send</strong> webhooks to your users, with retries, signatures, and subscriber management, on the same code whether you use the cloud or self-host it, these alternatives do that.',
  ...
  comparison: {
    ...
    rows: [
      ...
      { criteria: 'Open Source', hookdeckHtml: 'Partial (Outpost Apache-2.0, Gateway closed)', hook0Html: 'Source-available (SSPL-1.0)', svixHtml: 'Partial (open-core, enterprise closed)', convoyHtml: 'Source-available (Elastic License 2.0)', awsEventbridgeHtml: 'No (AWS proprietary)' },
  ...
  whyLookBeyond: {
    ...
    cards: [
      ...
      { title: 'You Want to Audit the Source Code', body: "Outpost is Apache-2.0, so Hookdeck's delivery code is readable, but the Event Gateway that ingests your webhooks stays closed. Hook0 publishes its whole codebase source-available under SSPL-1.0, and the managed cloud runs that same code, so you can read and audit every line.", color: 'indigo' },
    ],
  },
  faq: {
    eyebrow: 'FAQ',
    h2: 'Common Questions',
    items: [
      { q: 'Is Hookdeck open-source?', a: 'Partly. Outpost, Hookdeck\'s delivery component, is Apache-2.0 and self-hostable, and the repository is active. The Event Gateway that ingests webhooks stays closed-source and cloud-only. Hook0 is source-available under SSPL-1.0 with the whole platform self-hostable. Convoy is source-available under the Elastic License 2.0, which is not OSI-approved and forbids offering Convoy as a managed service.' },
