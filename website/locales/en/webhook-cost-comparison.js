...
module.exports = {
  ...
  costTable: {
    ...
    footnotes: [
      ...
      '⁴ Hookdeck Outpost managed is pay-as-you-go outbound delivery infrastructure at $10 per million events, no monthly minimum — that is the Starter tier, which does not include SSO, RBAC or SCIM. Those start on the Growth tier, at $499/month minimum on top of the per-event cost. Hookdeck also sells an inbound Event Gateway as a separate product with its own plans ($0 to $499/month).',
