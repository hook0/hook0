...
[Svix](https://www.svix.com/) is a webhook service backed by $13M in VC funding. Svix and Hook0 both focus on outbound webhook delivery. The difference: Svix is open-core (the self-hosted version has fewer features), Hook0 has the same features in cloud and self-hosted.
