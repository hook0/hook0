...
| **Manual replay** | ✅ | ✅ |
| **REST API** | ✅ | ✅ |
| **SDK languages** | JS, Python, Go, Ruby, Java, Kotlin, C# | JS, Rust, Python, Go, Ruby, PHP, C#, Java, Kotlin, Lua, Zig |
...
Hook0's free tier includes 100 events/day, no credit card. [Give it a spin](https://www.hook0.com/hook0-vs-svix).
