...
| **Manual replay** | ❌ | ✅ |
| **REST API** | ✅ | ✅ |
| **SDK languages** | JavaScript | JS, Rust, Python, Go, Ruby, PHP, C#, Java, Kotlin, Lua, Zig |
...
- [Webhook retry logic](/explanation/webhook-retry-logic) -- how Hook0 schedules backoff and replays failed deliveries
