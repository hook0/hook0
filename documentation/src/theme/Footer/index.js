...
const footerLinks = {
  ...
  developers: {
    title: 'Developers',
    items: [
      { label: 'Quick Start', to: '/tutorials/getting-started', icon: 'bolt' },
      { label: 'Documentation', to: '/', icon: 'book' },
      { label: 'API Reference', to: '/api', icon: 'api' },
      { label: 'SDK & Libraries', href: 'https://github.com/hook0/hook0', icon: 'code' },
      { label: 'Source Code', href: 'https://github.com/hook0/hook0', icon: 'github' },
      { label: 'Status Page', href: 'https://status.hook0.com', icon: 'status' },
      { label: 'Self-hosting', to: '/self-hosting/docker-compose', icon: 'server' },
    ],
  },
  community: {
    title: 'Community',
    items: [
      ...
      { label: 'YouTube', href: 'https://www.youtube.com/@hook0', icon: 'youtube' },
...
const socialLinks = [
  { name: 'Discord', href: 'https://www.hook0.com/community', icon: 'discord' },
  { name: 'GitHub', href: 'https://github.com/hook0/hook0', icon: 'github' },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/company/hook0', icon: 'linkedin' },
  { name: 'YouTube', href: 'https://www.youtube.com/@hook0', icon: 'youtube' },
  { name: 'Twitter', href: 'https://twitter.com/hook0_', icon: 'twitter' },
];
