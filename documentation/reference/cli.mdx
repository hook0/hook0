---
title: CLI reference
description: Reference for the Hook0 CLI
---
...
flowchart TD
    ...
    B -- "4. sends event<br/>via HTTP" --> D
    D -- "5. API delivers to<br/>subscription URL<br/>(= relay URL from step 2)" --> C
    C -- "6. relay forwards<br/>via WebSocket" --> E
