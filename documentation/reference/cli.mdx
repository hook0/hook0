...
|------------|-------------|
| **Local development** | Receive webhooks locally via WebSocket tunnel — like ngrok, but built into the CLI |
...
No account needed. Run this single command to launch an interactive demo:
