...
```
hook0 event send -----> Hook0 API ------> Relay Server -----> localhost:3000
                      (app.hook0.com)    (play.hook0.com)      (your server)
                         delivers         forwards via
                        to matching       WebSocket tunnel
                       subscriptions      (hook0 listen)
```
