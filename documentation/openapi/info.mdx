...
# Or http://localhost:8081/api/v1 for testing locally
```
...
- [Go](../reference/sdk/go)
- [Ruby](../reference/sdk/ruby)
- [PHP](../reference/sdk/php)
- [C#](../reference/sdk/csharp)
- [Java](../reference/sdk/java)
- [Kotlin](../reference/sdk/kotlin)
- [Lua](../reference/sdk/lua)
- [Zig](../reference/sdk/zig)

Each one sends events, declares event types, verifies webhook signatures, and exposes every operation on this page as a generated, typed method. See [SDKs & client libraries](../reference/sdk/index.md).
