 ...
 * ```
 */
export interface VueStateDeclaration extends StateDeclaration, VueViewDeclaration {
  /**
   ...
   * the `views` object.
   */
  views?: { [key: string]: VueViewDeclaration };
}

/**
 * Declares a view on some state
 */
export interface VueViewDeclaration extends _ViewDeclaration {
  /**
   * The Vue `Component` to use for this view.
   *
   * A property of [[VueStateDeclaration]] or [[VueViewDeclaration]]:
   *
   * The Vue Component which will be used for this view.
   *
