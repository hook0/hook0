  ...
  <Promised :promise="applications$">
    ...
    <template #default="applications">
      <hook0-card>
        ...
        <hook0-card-footer>
          <hook0-button class="primary" type="button" @click="$router.push({name:routes.OrganizationsNew})">Create new
            organization
          </hook0-button>
        </hook0-card-footer>
      </hook0-card>
...
import {list, Organization} from "@/pages/organizations/OrganizationService";
...
export default class OrganizationList extends Vue {
  private applications$ !: Promise<Array<Organization>>;
