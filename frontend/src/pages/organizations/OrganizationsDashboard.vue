...
const consumptions = computed<ConsumptionQuota[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      consumption: organization.value.quotas.days_of_events_retention_limit ?? 0,
      quota: organization.value.quotas.days_of_events_retention_limit ?? 0,
      displayValue: String(organization.value.quotas.days_of_events_retention_limit ?? 0),
