  ...
  <Promised :promise="application_secrets$">
    ...
    <template #default="application_secrets">
      <hook0-card>
        ...
        <hook0-card-content v-else>
          <hook0-card-content-lines>
            <hook0-card-content-line type="full-width">
              <template #content>
                <hook0-text>Hook0 authenticates your API requests using your application’s API keys. If you don’t
                  include your key when making an API request, or use an incorrect or outdated one, Hook0 returns a 401
                  -
        ...
        <hook0-card-footer>
          <hook0-button class="primary" type="button" @click="createNew">Create new API Key
          </hook0-button>
        </hook0-card-footer>
      </hook0-card>
    </template>
