  ...
  <footer class="bg-white">
    <div class="footer-container">
      ...
      <div class="footer-icons">
        <a href="https://twitter.com/cloud_iam_com" class="footer-icon">
        ...
        <a href="https://github.com/cloud-iam" class="footer-icon">
      ...
      <p class="footer-text">
        &copy; Cloud IAM, Keycloak is a registered trademark of Red Hat, Cloud-IAM is not affiliated in any way with Red
        Hat.
      </p>
    </div>
  </footer>
