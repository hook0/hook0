        ...
        <div class="flex flex-col h-0 flex-1">
          ...
          <div class="flex-1 flex flex-col overflow-y-auto">
            <nav class="flex-1 px-2 py-4 bg-gray-800 space-y-1">
              ...
              <menu-item :active="false" name="Applications">
                <icon kind="document"></icon>
              </menu-item>

              <menu-item :active="false" name="Event Types">
                <icon kind="document"></icon>
              </menu-item>

              <menu-item :active="false" name="Webhooks">
                <icon kind="folder"></icon>
              </menu-item>

              <menu-item :active="false" name="Logs">
                <icon kind="calendar"></icon>
              </menu-item>

              <menu-item :active="false" name="Settings">
                <icon kind="document"></icon>
              </menu-item>
            </nav>
          </div>
