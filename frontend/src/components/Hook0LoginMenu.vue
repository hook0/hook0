      ...
      <template v-slot:dropdown="parent">
        <hook0-dropdown-menu-items>
          <hook0-dropdown-menu-item-text>
            ...
            <hook0-text class="block bold text-gray-900 truncate"> {{ currentUser.email }}</hook0-text>
          </hook0-dropdown-menu-item-text>
        </hook0-dropdown-menu-items>
        <hook0-dropdown-menu-items>
        ...
        <hook0-dropdown-menu-items>
          <hook0-dropdown-menu-item-link data-e2e="logout" @click="logout();parent.close()">
            Logout
          </hook0-dropdown-menu-item-link>
        </hook0-dropdown-menu-items>
      </template>
