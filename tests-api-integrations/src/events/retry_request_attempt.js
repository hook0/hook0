 ...
 */
export function retryHappyPath(base_url, service_token, request_attempt_id) {
  const res = http.post(
    `${base_url}api/v1/request_attempts/${request_attempt_id}/retry`,
    null,
 ...
 */
export function retryCooldown(base_url, service_token, request_attempt_id) {
 ...
 */
export function retryNonExistent(base_url, service_token) {
  const fake_attempt_id = '00000000-0000-0000-0000-000000000000';
  const res = http.post(
    `${base_url}api/v1/request_attempts/${fake_attempt_id}/retry`,
    null,
    { headers: headers(service_token) }
  );
