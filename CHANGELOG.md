...
- Move VERSION export to before_script for proper shell expansion (ci)
...
- Ensure tests pass before release (ci)
...
[2.0.7]: https://gitlab.com/hook0/hook0/-/compare/v2.0.6...v2.0.7
